...
class Helper extends Controller 
{
  ...
  /////retorna el objeto JSON seleccionado por el $numero eg: "de lo chequeado por el apoderado", o de lo contrario lanza error y nos retorna a la url actual
   ...
   //*DEPRECADO, AHORA SOLO SE OBTIENEN LOS IDS DESDE EL HTML Y NO EL OBJETO COMPLETO POR SEGURIDAD*/
