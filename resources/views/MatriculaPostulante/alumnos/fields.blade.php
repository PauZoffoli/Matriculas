...
<div class="form-group col-sm-6 {{ $errors->has('$persona->alumno->estadoCivilPadres') ? ' has-error' : '' }}">
...
<div class="form-group" >
  ...
  <div class="col-sm-12 inputGroupContainer">
    <div class="input-group">
      ...
      {!! Form::select('alumno[repitencias]', [0,1,2,3,4,5],  $persona->alumno->repitencia()->count() ,  array('id' => 'enumerator', 'class' => 'form-control','placeholder' => 'Seleccione la cantidad de veces que ha repetido el alumno', 'required'=>'true')) !!}
