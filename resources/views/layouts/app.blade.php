...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/font-awesome/5.5.0/css/all.css') }}">

    <!-- Ionicons -->
    <link rel="stylesheet" href="{{ asset('css/ionicons/2.0.1/ajax/ionicons.min.css') }}">

    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('css/admin-lte/2.4.3/AdminLTE.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/admin-lte/2.4.3/skins/_all-skins.min.css') }}">

    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('css/iCheck/1.0.2/skins/square/_all.css') }}">

    <link rel="stylesheet" href="{{ asset('css/select2/4.0.5/select2.min.css') }}">
...
actionIfNotNull('PorcentajeBeca', becaTotalSegunCadaBecaIndividual)
